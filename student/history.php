...
<html lang="en">
    ...
    <head>
        ...
        <link type="text/css" href="css/theme.css?v=<?php echo time(); ?>
" rel="stylesheet">
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.php">Our Library </a>
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy; Project WAP 2021 </b>All rights reserved.
            </div>
        </div>
